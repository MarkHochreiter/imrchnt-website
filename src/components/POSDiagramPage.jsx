...
function POSDiagramPage({ onNavigateBack }) {
  ...
  const deviceFeatures = {
    'desktop': [// Desktop position grid - every 5% increment
...
for (let top = 0; top <= 100; top += 5) {
  for (let left = 0; left <= 100; left += 5) {
    desktopPositions.push({
      ...
      description: `Position marker at ${top}% top, ${left}% left`,
...
// This creates 441 positions (21 x 21 grid)
// Copy the array content below to replace the desktop features
...
'desktop': [
  ...
  {
    id: 438,
    title: "top 100 left 85",
    description: "Position marker at 100% top, 85% left",
    icon: <Monitor size={20} />,
