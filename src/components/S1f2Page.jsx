        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border-2 border-gray-200">
              ...
              <div className="text-4xl font-bold text-[#f08e80] mb-2">$25.2</div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border-2 border-[#f08e80]">
              ...
              <div className="text-4xl font-bold text-[#f08e80] mb-2">$540</div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-center mb-4">
                <Printer className="h-12 w-12 text-[#f08e80] mx-auto" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Receipt Rolls</h3>
