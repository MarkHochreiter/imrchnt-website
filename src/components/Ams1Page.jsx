    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-900">AMS1</h1>
                  <p className="text-xl text-[#f08e80] font-medium">All-in-one terminal running on Android</p>
                </div>
              </div>
            ...
            <div className="bg-gray-100 rounded-lg p-8 flex items-center justify-center">
              <img src={ams1Image} alt="AMS1 Terminal" className="max-w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">4" Color Display</h3>
              <p className="text-gray-600">High-resolution 4" color touchscreen display for easy interaction and app usage.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <Wifi className="h-8 w-8 text-[#f08e80] mb-4" />
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Dual Connectivity</h3>
              <p className="text-gray-600">Wi-Fi and cellular connectivity with automatic failover for uninterrupted service.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between py-2 border-b border-gray-200">
                  ...
                  <span className="text-gray-900">Quad-core, 1.3 GHz, ARM Cortex-A7 32-bit RISC</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="text-gray-600">Memory</span>
                  <span className="text-gray-900">16GB Flash & 2GB RAM</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="text-gray-600">Battery</span>
                  <span className="text-gray-900">2598 mAh (10Wh), replaceable</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-200">
      ...
      <section className="py-16 bg-[#f08e80]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to get started with AMS1?</h2>
